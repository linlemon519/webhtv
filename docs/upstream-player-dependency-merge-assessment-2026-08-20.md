...
| 23 | `C4` | 通用/上游应用合并 | 合并 `fish2018/webhtv:main` 的应用、播放器与供应链增量 | **第二轮已验证，待提交收口**：首轮 `d0809f804f812b818bcb22f36cae8634022db673` 已完成；本轮从共同祖先 `ec478b0b697422a7785171c7b51a35b7a526564e` 合并 51 个提交至目标 `784b90420d646eb6c7ddcc63ad622a92c65b02b4`；双 ABI native 门禁、Mobile/Leanback Arm64 Java 编译、受影响 Exo 单测和 `git diff --check` 已通过，保留本地后续修复、任务文档和受保护备份 | [C4-main-upstream-merge.md](C4-main-upstream-merge.md) |
